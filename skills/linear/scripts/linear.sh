...
get_state_id() {
  ...
  case "$state_name" in
    ...
    progress|dev|development) state_name="In Development" ;;
    review|code-review) state_name="Code Review" ;;
    ready|ready-for-dev) state_name="Ready for Development" ;;
    done) state_name="Done" ;;
    blocked) state_name="Blocked" ;;
    backlog) state_name="Backlog" ;;
    qa) state_name="In QA" ;;
    # Pass through custom state names as-is
    *) ;;
  esac
